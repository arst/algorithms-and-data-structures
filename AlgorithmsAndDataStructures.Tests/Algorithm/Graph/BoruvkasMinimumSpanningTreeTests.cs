...
namespace AlgorithmsAndDataStructures.Tests.Algorithm.Graph
{
    public class BoruvkasMinimumSpanningTreeTests
    {
        ...
        public void BaseLine()
        {
            ...
            {
                new Edge { Source = 0, Destination = 1, Weight = 14 },
                new Edge { Source = 0, Destination = 2, Weight = 9 },
                new Edge { Source = 0, Destination = 3, Weight = 7 },
                new Edge { Source = 1, Destination = 4, Weight = 9 },
                new Edge { Source = 1, Destination = 2, Weight = 2 },
                new Edge { Source = 2, Destination = 3, Weight = 10 },
                new Edge { Source = 2, Destination = 5, Weight = 11 },
                new Edge { Source = 3, Destination = 5, Weight = 15 },
                new Edge { Source = 4, Destination = 5, Weight = 6 }
            };
