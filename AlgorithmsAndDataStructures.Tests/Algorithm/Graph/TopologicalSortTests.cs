...
public class TopologicalSortTests
{
    ...
    public void TopologicalSortForOneVertexGraph()
    {
        ...
        Assert.Collection(topologicalOrder, arg => Assert.Equal(0, arg));
    }
    ...
    public void TopologicalSortForTwoVertexGraph()
    {
        ...
        var node1 = new GraphVertex<int>
        {
            AdjacentVertices = new List<int> { 1 }
        };
        ...
        Assert.Collection(topologicalOrder, arg => Assert.Equal(0, arg), arg => Assert.Equal(1, arg));
    }
    ...
    public void TopologicalSortForGraphWithCycle()
    {
        ...
        var node2 = new GraphVertex<int>
        {
            AdjacentVertices = new List<int> { 0 }
        };
    ...
    public void TopologicalSortForDisconectedGraph()
    {
        ...
        Assert.Collection(topologicalOrder, arg => Assert.Equal(2, arg), arg => Assert.Equal(0, arg),
    ...
    public void Baseline()
    {
        ...
        var node1 = new GraphVertex<int>
        {
            AdjacentVertices = new List<int> { 1, 2 }
        };
        ...
        var node3 = new GraphVertex<int>
        {
            AdjacentVertices = new List<int> { 3, 5 }
        };

        var node4 = new GraphVertex<int>
        {
            AdjacentVertices = new List<int> { 4 }
        };
        ...
        Assert.Collection(topologicalOrder,
