...
#pragma warning restore CA1822 // Mark members as static
    {
        if (population is null) return Array.Empty<int>();
        ...
        for (var i = 0; i < sampleSize; i++) reservoir[i] = population.GetNext();
        ...
        while (nextSample > 0)
        {
            ...
            if (probabilityToPickNextSample <= sampleSize) reservoir[probabilityToPickNextSample - 1] = nextSample;
