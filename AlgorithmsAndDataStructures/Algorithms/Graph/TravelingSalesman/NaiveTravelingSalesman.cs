...
#pragma warning restore CA1822 // Mark members as static
        ...
        private static int TravelingSalesman(IReadOnlyList<int[]> graph, int currentVertex, IList<bool> visited, int currentPathWeight, int minPathWeight)
        {
            ...
            for (var i = 0; i < graph.Count; i++)
            {
                ...
                visited[i] = true;
                minPathWeight = TravelingSalesman(graph, i, visited, currentPathWeight + graph[currentVertex][i], minPathWeight);
                visited[i] = false;
            }
