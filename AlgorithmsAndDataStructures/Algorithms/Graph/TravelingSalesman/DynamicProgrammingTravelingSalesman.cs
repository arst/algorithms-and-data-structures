...
#pragma warning restore CA1822 // Mark members as static
    ...
    private static int Travel(IReadOnlyList<int[]> graph, IReadOnlyList<int[]> dp, int allVisited, int currentRoute,
        int currentCity)
    {
            ...
            if ((currentRoute & (1 << city)) == 0)
            {
                var distanceThroughCity = graph[currentCity][city] +
                                          Travel(graph,
                                              ...
                                              allVisited,
                                              currentRoute |
                                              (1 << city) /*to ensure that city is included in the route*/,
