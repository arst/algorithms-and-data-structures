...
public class BinarySearchApproach : IMediaOfTwoArraysAlgorithm
{
    ...
    private static float GetMedian(IReadOnlyList<int> left, int leftStart, int leftEnd, IReadOnlyList<int> right,
        int rightStart, int rightEnd)
    {
        ...
        if (Math.Abs(leftMedian - rightMedian) < 0.1) return leftMedian;
    ...
    private static int[] Merge(IReadOnlyList<int> left, int leftStart, int leftEnd, IReadOnlyList<int> right,
        int rightStart, int rightEnd)
    {
    ...
    private static void UpFillArray(IList<int> result, IReadOnlyList<int> source, int resultIndex, int sourceStart,
        int sourceEnd)
    {
